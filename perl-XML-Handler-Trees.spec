...
Requires: perl-XML-Handler-Trees-license
Requires: perl-XML-Handler-Trees-man
...
%package man
Summary: man components for the perl-XML-Handler-Trees package.
Group: Default

%description man
man components for the perl-XML-Handler-Trees package.
...
mkdir -p %{_topdir}/BUILD/XML-Handler-Trees-0.02/deblicense/
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/perl-XML-Handler-Trees
cp deblicense/copyright %{buildroot}/usr/share/doc/perl-XML-Handler-Trees/deblicense_copyright
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/XML/Handler/Trees.pm

%files license
%defattr(-,root,root,-)
/usr/share/doc/perl-XML-Handler-Trees/deblicense_copyright
